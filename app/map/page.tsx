...
export default function Page() {
  ...
  return (
    <main className="relative w-screen overflow-hidden bg-forest-950 h-[calc(100vh-3.5rem)] [height:calc(100dvh-3.5rem)]">
      <h1 className="sr-only">
        Trailspark — interactive map of {TRAILS.length.toLocaleString()} hiking trails on the US West Coast
      </h1>
      <Map
